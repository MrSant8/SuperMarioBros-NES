...
enum class PlayerAnim {
    IDLE_LEFT, IDLE_RIGHT, IDLE_RIGHT_BIG, IDLE_LEFT_BIG,IDLE_RIGHT_FIRE,IDLE_LEFT_FIRE, IDLE_RIGHT_STAR, IDLE_LEFT_STAR, IDLE_RIGHT_STAR_BIG, IDLE_LEFT_STAR_BIG,
    WALKING_LEFT, WALKING_RIGHT, WALKING_LEFT_BIG, WALKING_RIGHT_BIG, WALKING_LEFT_FIRE, WALKING_RIGHT_FIRE, WALKING_LEFT_STAR, WALKING_RIGHT_STAR, WALKING_LEFT_STAR_BIG, WALKING_RIGHT_STAR_BIG,
    JUMPING_LEFT, JUMPING_RIGHT, JUMPING_LEFT_BIG, JUMPING_RIGHT_BIG, JUMPING_LEFT_FIRE, JUMPING_RIGHT_FIRE, JUMPING_LEFT_STAR, JUMPING_RIGHT_STAR, JUMPING_LEFT_STAR_BIG, JUMPING_RIGHT_STAR_BIG,
    LEVITATING_LEFT, LEVITATING_RIGHT, LEVITATING_LEFT_BIG, LEVITATING_RIGHT_BIG, LEVITATING_LEFT_FIRE, LEVITATING_RIGHT_FIRE, LEVITATING_LEFT_STAR, LEVITATING_RIGHT_STAR, LEVITATING_LEFT_STAR_BIG, LEVITATING_RIGHT_STAR_BIG,
    FALLING_LEFT, FALLING_RIGHT, FALLING_LEFT_BIG, FALLING_RIGHT_BIG, FALLING_LEFT_FIRE, FALLING_RIGHT_FIRE, FALLING_LEFT_STAR_BIG, FALLING_RIGHT_STAR_BIG, FALLING_LEFT_STAR, FALLING_RIGHT_STAR, WALKING_RIGHT_LEFT, WALKING_RIGHT_RIGHT,
    CLIMBING, CLIMBING_PRE_TOP, CLIMBING_TOP,
    SHOCK_LEFT, SHOCK_RIGHT,
    DEAD,CROUCH_BIG_LEFT,CROUCH_BIG_RIGHT, CROUCH_FIRE_LEFT, CROUCH_FIRE_RIGHT, CROUCH_STAR_LEFT, CROUCH_STAR_RIGHT,
    FLAG_LEFT,FLAG_RIGHT, FLAG_LEFT_BIG, FLAG_RIGHT_BIG, FLAG_LEFT_FIRE, FLAG_RIGHT_FIRE, FLAG_LEFT_STAR, FLAG_RIGHT_STAR, FLAG_LEFT_STAR_BIG, FLAG_RIGHT_STAR_BIG,
